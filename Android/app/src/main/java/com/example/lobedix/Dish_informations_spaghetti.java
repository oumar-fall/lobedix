...
public class Dish_informations_spaghetti extends AppCompatActivity {
        ...
        view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (title.equals("espace")){ // Changer d'espace
                    startActivity(new Intent(Dish_informations_spaghetti.this, Enfant_Adulte.class));}
                ...
                if (title.equals("menus")){
                    startActivity(new Intent(Dish_informations_spaghetti.this, Menus.class));}
    ...
    public void nutriscore(View view){
        ...
        Intent nutri = new Intent(Dish_informations_spaghetti.this, Dish_Informations_Nutri_Spaghetti.class);
        startActivity(nutri);
    }
    ...
    public void boisson(View view){
        Intent boisson = new Intent(Dish_informations_spaghetti.this, Boisson_spaghetti.class);
