...
public class Boisson_taboulet extends AppCompatActivity {
        ...
        view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if(title.equals("aperitif")){ // Choix apéro
                    startActivity(new Intent(Boisson_taboulet.this, ChoixApero.class));}

                if (title.equals("espace")){ // Changer d'espace
                    startActivity(new Intent(Boisson_taboulet.this, Enfant_Adulte.class));}

                if (title.equals("commande")){ // Ma commande
                    startActivity(new Intent(Boisson_taboulet.this, MyCommand.class));}

                if (title.equals("entrees")){
                    startActivity(new Intent(Boisson_taboulet.this, listeEntrees.class));}

                if (title.equals("plats")){ // Nos plats
                    startActivity(new Intent(Boisson_taboulet.this, listePlats.class));}

                if (title.equals("desserts")){ // Nos desserts
                    startActivity(new Intent(Boisson_taboulet.this, listeDesserts.class));}

                if (title.equals("coupdepouce")){ // Coup de pouce
                    startActivity(new Intent(Boisson_taboulet.this, CommandType.class));}

                if (title.equals("quitter")){ // Quitter
                    startActivity(new Intent(Boisson_taboulet.this, MainActivity.class));}

                if (title.equals("menus")){
                    startActivity(new Intent(Boisson_taboulet.this, Menus.class));}
    ...
    public void addBoisson(View view){
        ...
        Integer nbBoisson = DataHolder.getInstance().getNbBoissonTaboule() +1;
        Hashtable<String,Integer> d = DataHolder.getInstance().getBoisson();
        d.put("Boisson taboule",nbBoisson);
        DataHolder.getInstance().setNbBoissonTaboule(nbBoisson);
        Toast.makeText(this, "Vous venez de commander un verre de Vin Rosé Tavel La Cave d'Augustin Florent supplémentaire", Toast.LENGTH_SHORT).show();
    ...
    public void gererCommande(View view){
        Intent command = new Intent(Boisson_taboulet.this, MyCommand.class);
