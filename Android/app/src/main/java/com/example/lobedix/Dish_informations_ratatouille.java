...
public class Dish_informations_ratatouille extends AppCompatActivity {
    ...
    public void nutriscore(View view){
        ...
        Intent nutri = new Intent(Dish_informations_ratatouille.this, Dish_Informations_Nutri_Ratatouille.class);
        startActivity(nutri);
    }
    ...
    public void boisson(View view){
        Intent boisson = new Intent(Dish_informations_ratatouille.this, Boisson_ratatouille.class);
